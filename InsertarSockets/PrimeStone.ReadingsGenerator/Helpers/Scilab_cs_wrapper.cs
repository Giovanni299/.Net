...
namespace Primestone.ReadingsGenerator.Helpers
{
    using System;
 ...
 */
    class Scilab_cs_wrapper
    {
        ...
        // C:\Program Files\scilab-5.5.2\bin\
        private const string CALL_SCILAB_DLL = @"C:\Program Files\scilab-6.0.0-beta-2\bin\call_scilab.dll";
        private const string API_SCILAB_DLL = @"C:\Program Files\scilab-6.0.0-beta-2\bin\api_scilab.dll";
        private const string GRAPHICS_DLL = @"C:\Program Files\scilab-6.0.0-beta-2\bin\graphics.dll";
        private const string OUTPUT_STREAM_DLL = @"C:\Program Files\scilab-6.0.0-beta-2\bin\scioutput_stream.dll";
        ...
        /// 
        /// </summary>
        /// <param name="SCIpath"></param>
        /// <param name="advancedMode"></param>
        /// <param name="ScilabStartup"></param>
        /// <param name="Stacksize"></param>
        /// <returns></returns>
        [DllImport(CALL_SCILAB_DLL, CharSet = CharSet.Ansi)]
        public static extern int Call_ScilabOpen([In] String SCIpath, bool advancedMode, [In] String ScilabStartup, [In] Int32[] Stacksize);
        ...
        public static extern api_Err createNamedMatrixOfWideString([In]IntPtr pvApiCtx, [In] String _pstName, [In] int _iRows, [In] int _iCols, [In] String[] _pstStrings);
